...
La planificación se estructuró en etapas en lugar de Sprints formales, dada la naturaleza continua del trabajo. A continuación se detalla la secuencia de tareas e hitos principales:
...
El servidor responde con códigos \acrshort{http} estándar (200 OK, 201 Created, 400 Bad Request, 404 Not Found) y mensajes \acrshort{json} estructurados que incluyen estado, datos y mensajes de error cuando corresponde.
      ...
      \begin{verbatim}
{
  ...
  "endDate": "2024-12-31"     // opcional
      ...
      \end{verbatim}
      \item \textbf{Response}: stream binario del Excel (200 OK) o mensaje de error/duplicado (400 Bad Request).
    \end{itemize}
...
Las tareas de mejora se distribuyeron a lo largo de los tres meses, abordando aspectos críticos como la seguridad de las dependencias, la cobertura de pruebas, la refactorización del código y la eliminación de duplicaciones. A continuación, se describen en detalle las principales categorías de tareas de mejora abordadas durante el proyecto.
